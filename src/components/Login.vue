<template>
    <div style="text-align: center;height:519px;">
        ...
        <el-form style="width: 300px;border: #409EFF 1px solid;position: absolute; left: 50%;top: 50%;transform: translate(-50%,-50%);border-radius: 20px;padding: 10px;"  v-loading="loading" element-loading-text="加载中...">
